...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex flex-col w-full py-1 px-1 md:py-2 md:px-3 lg:px-8 border-4 border-white rounded-2xl transition-all duration-300">
      {/* Top navigation bar */}
      <div className="w-full [background-color:#aec3c3] py-2 px-2 md:py-3 md:px-5 shadow rounded-t-2xl mx-0">
